                ...
                <div class="table-responsive">
                    <table class="table table-bordered table striped mt-1">
                        <thead class="text-while" style="background: #3B3F5C">
                            <tr>
                                <th class="table-th text-while">USUARIO</th>
                                <th class="table-th text-while text-center">TELEFONO</th>
                                <th class="table-th text-while text-center">EMAIL</th>
                                <th class="table-th text-while text-center">PERFIL</th>
                                <th class="table-th text-while text-center">ESTATUS</th>
                                <th class="table-th text-while text-center">IMÁGEN</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($r->image != null)
                                    <img src="{{asset('storage/users/'.$r->image)}}" alt="imagen" height="70" width="80"
                                    {{-- class="card-img-top img-fluid"> --}} class="rounded">
                                    @endif
                                </td>
