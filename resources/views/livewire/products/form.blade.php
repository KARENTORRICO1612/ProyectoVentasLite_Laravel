...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4">
        <div class="form-group">
            <label>Código</label>
            <input type="text" wire:model.lazy="bardcode" class="form-control" placeholder="ej: C025974">
            @error('bardcode') <span class="text-danger er">{{$message}}</span>@enderror
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-8">
        <div class="form-group custom-file">
           <input type="file" class="custom-file-input form-contro" wire:model="image"
           accept="image/*">
