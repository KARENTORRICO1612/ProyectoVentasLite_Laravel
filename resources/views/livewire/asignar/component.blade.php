    ...
    <div class="col-sm-12">
        <div class="widger widget-chart-one">
            ...
            <div class="widget-content">
                ...
                <div class="row mt-3">
                    <div class="col-sm-12">
                        {{-- //Pegando código para tabla--}}
                        <div class="widget-content">
                            <div class="table-responsive">
                                <table class="table table-bordered table striped mt-1">
                                    <thead class="text-while" style="background: #3B3F5C">
                                        <tr>
                                            <th class="table-th text-while text-center">ID</th>
                                            <th class="table-th text-while text-center">PERMISO</th>
                                            <th class="table-th text-while text-center">ROLES CON EL PERMISO</th>
                                        </tr>
                                    </thead>
                                            ...
                                            <td class="text-center">
                                                <div class="n-check">
                                                    <label class="new-control new-checkbox checkbox-primary">
                                                        <input type="checkbox" wire:change="syncPermiso($('#p' + {{$permiso->id
                                                    }}).is(':checked'),'{{$permiso->name}}' )" id="p{{$permiso->id}}"
